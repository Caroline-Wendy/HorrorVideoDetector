...
复杂度 : 无
备注 : 无
典型用法 : num = HorrorVideoSceneNum (_fileName, _shotInterval, _sceneShotNum);
--------------------------------------------------------------------------------
作者 : C.L.Wang
</PRE>
*******************************************************************************/ 
...
{
	std::clog << std::endl;
	_printLog(std::clog, "----------Begin HorrorVideoSceneNum! ----------");
	std::clog << std::endl;
	...
	std::clog << std::endl;
	_printLog(std::clog, "----------End HorrorVideoSceneNum! ----------");
	std::clog << std::endl;
...
{
	std::clog << std::endl;
	_printLog(std::clog, "----------Begin HorrorVideoDetector! ----------");
	std::clog << std::endl;
...
{
	std::clog << std::endl;
	_printLog(std::clog, "----------Begin HorrorVideoDetector_Image! ----------");
	std::clog << std::endl;
	...
	std::clog << std::endl;
	_printLog(std::clog, "----------End HorrorVideoDetector_Image! ----------");
	std::clog << std::endl;
...
void HorrorVideoDetector_Help (void)
{
	...
	std::cout << std::endl;
	std::cout << "恐怖视频视频检测器(" << version << ")" << std::endl;
	...
	std::cout << "方法描述: 加载模型->检测视频是否为恐怖." << std::endl;
	std::cout << "本程序使用, 需要附加恐怖视频检测模型." << std::endl;
